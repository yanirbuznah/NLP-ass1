...
#Local Tagger
subprocess.check_call(["python", "Local Feature-based Tagger/ExtractFeatures.py", "ass1data/data/ass1-tagger-train", "fetures_file"])
subprocess.check_call(["python", "Local Feature-based Tagger/TrainModel.py", "fetures_file", "model_file"])
